    ...
    def patched_receive(self_mgr, message, sender, request_reply=None, silent=False):
                ...
                try:
                    ...
                    if _is_save_spell:
                        ...
                        def _apply_save_damage(cible_sv, dmg_sv, label_sv):
                            ...
                            _dl_res: dict = {}
                            def _dl_cb(final, target_val=None, _ev=_dl_ev, _res=_dl_res):
                                _app._unregister_approval_event(_ev)
                                _res["amount"] = final
        ...
        if (not is_system
            ...
            for _sub_idx, _sub in enumerate(_all_subactions, start=1):
                ...
                if _sub["type_label"].lower() in ("mouvement", "move"):
                ...
                if _confirmed:
                    ...
                    if _is_single_atk:
                        ...
                        def _dmg_link_cb(final_amount, target_val=None, _ev=_dmg_ev, _res=_dmg_res):
                            _app._unregister_approval_event(_ev)
                        ...
                        if _is_spell_attack:
                            ...
                            def _apply_save_dmg2(cible_s2, dmg_s2, label_s2):
                                ...
                                _dl2_res: dict = {}
                                def _dl2_cb(final2, target_val=None, _ev=_dl2_ev, _res=_dl2_res):
                                    _app._unregister_approval_event(_ev)
                                    _res["amount"] = final2
                                    _res["target"] = target_val
                                    _ev.set()
                        ...
                        if _is_spell_attack:
                            ...
                            if not _spell_hit:
                                ...
                                _s_dmg_res = {}
                                def _s_dmg_cb(amount, target_val=None, _ev=_s_dmg_ev, _res=_s_dmg_res):
                                    _app._unregister_approval_event(_ev)
                                    _res["amount"] = amount
                                    _res["target"] = target_val
                                    _ev.set()
